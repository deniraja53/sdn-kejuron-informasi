      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <motion.div
            ...
            className="sm:col-span-2 bg-pink-50 p-8 rounded-[2.5rem] border border-pink-100 shadow-sm flex flex-col md:flex-row items-center justify-between gap-6"
          >
            <div className="space-y-2 text-center md:text-left">
              <h3 className="text-xl font-bold text-pink-900">Butuh Respon Cepat?</h3>
              <p className="text-pink-700 text-sm">Hubungi tim administrasi kami langsung melalui WhatsApp.</p>
            </div>
            <Button 
        ...
        <motion.div
          ...
          className="bg-white p-4 rounded-[3rem] border border-slate-100 shadow-xl h-[500px] overflow-hidden relative group"
        >
          <iframe 
          ...
          ></iframe>
          <div className="absolute bottom-8 left-8 right-8 bg-white/90 backdrop-blur-md p-6 rounded-2xl border border-white/20 shadow-lg flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm font-bold text-slate-900">Kec. Taman, Kota Madiun</p>
              </div>
            </div>
