...
import { History, Target, ShieldCheck, Heart, Users, Star, GraduationCap, Building2 } from 'lucide-react';
...
const values = [
  ...
  {
    title: 'Inovasi',
    description: 'Selalu mencari cara baru yang kreatif untuk memecahkan masalah.',
    icon: <Star className="w-8 h-8 text-accent" />,
    color: 'from-cyan-500/20 to-transparent'
  },
  {
    title: 'Kolaborasi',
    description: 'Bekerja sama untuk mencapai hasil terbaik bagi seluruh siswa.',
    icon: <Users className="w-8 h-8 text-purple-500" />,
    color: 'from-purple-500/20 to-transparent'
  },
  {
    title: 'Empati',
    description: 'Memahami dan menghargai perasaan serta perspektif orang lain.',
      ...
      <div className="container mx-auto px-4 md:px-6 space-y-24">
        ...
        <section className="text-center space-y-6 relative py-20 px-6 rounded-[3rem] overflow-hidden">
          ...
          <div className="relative z-10 max-w-4xl mx-auto space-y-6">
            ...
            >
              ...
              <span className="text-primary drop-shadow-[0_0_30px_rgba(255,0,127,0.5)]">Berkarakter</span>
            </motion.h1>
            ...
            >
              SDN KEJURON berkomitmen untuk menyelenggarakan pendidikan berkualitas tinggi yang menggabungkan nilai-nilai tradisional dengan inovasi teknologi modern.
            </motion.p>
          </div>
        </section>
        ...
        <section className="space-y-12">
          <div className="flex items-center gap-4">
            ...
            <span className="text-xs font-black uppercase tracking-[0.5em] text-slate-500">Jejak Langkah</span>
            <h2 className="text-3xl font-black text-white italic uppercase tracking-tighter">Sejarah Sekolah</h2>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            >
              <div className="relative p-10 rounded-[2.5rem] bg-slate-900/50 border-2 border-white/5 hover:border-primary/40 transition-all duration-500 shadow-2xl">
                <p className="text-xl text-slate-300 leading-relaxed italic">
                  "Didirikan pada tahun 1980, SDN KEJURON berawal dari sebuah bangunan sederhana dengan visi besar untuk menciptakan akses pendidikan yang berkeadilan bagi seluruh anak di wilayah Madiun."
                </p>
                <div className="mt-8 space-y-4 text-slate-400 leading-relaxed">
                  <p>
                    Selama dekade terakhir, sekolah kami telah bertransformasi menjadi institusi pendidikan yang modern, tetap mengakar pada keramahan dan kedisiplinan kota Madiun. Kami terus beradaptasi dengan perubahan zaman, mengintegrasikan teknologi ke dalam setiap ruang kelas.
                  </p>
                  <p>
                    Hari ini, SDN KEJURON dikenal sebagai salah satu sekolah dasar unggulan di Jawa Timur, melahirkan ribuan alumni yang telah sukses berkontribusi di berbagai bidang pembangunan bangsa.
                  </p>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="absolute bottom-10 left-10 text-white">
                <span className="text-[120px] font-black opacity-10 leading-none">1980</span>
                <p className="text-xs font-black uppercase tracking-widest text-primary italic">Awal dari sebuah perjalanan besar</p>
              </div>
            </motion.div>
          </div>
        </section>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            ...
            <div className="relative z-10 space-y-6">
              ...
              <h3 className="text-4xl font-black text-white italic uppercase tracking-tighter">Visi Utama</h3>
              <p className="text-2xl text-slate-100 font-bold leading-tight tracking-tight italic">
                "Menjadi lembaga pendidikan pilihan yang unggul dalam melahirkan generasi religius, cerdas, inovatif, dan berwawasan lingkungan."
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="relative z-10 space-y-6">
              ...
              <h3 className="text-4xl font-black text-white italic uppercase tracking-tighter">Misi Sekolah</h3>
        ...
        <section className="space-y-12">
          <div className="text-center space-y-4">
            <span className="text-[10px] font-black uppercase tracking-[0.8em] text-primary">Prinsip Kami</span>
            <h2 className="text-4xl md:text-6xl font-black text-white italic uppercase tracking-tighter italic shadow-glow">Nilai-Nilai Dasar</h2>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((v, i) => (
              ...
              >
                <div className={`absolute inset-0 bg-gradient-to-b ${v.color}`} />
                <div className="relative z-10 space-y-6">
                  ...
                  <h4 className="text-2xl font-black text-white uppercase tracking-tight">{v.title}</h4>
        ...
        <section className="text-center pt-24 pb-12">
          ...
          >
            ...
            <h2 className="text-3xl md:text-5xl font-black text-white uppercase tracking-tighter leading-tight italic">
              ...
              <span className="text-accent underline decoration-primary/50 underline-offset-8">Emas Masa Depan</span>
            </h2>
            <p className="text-slate-400 max-w-2xl mx-auto text-lg font-medium">
              Kami percaya setiap anak memiliki potensi jenius yang unik. Temukan cara kami mengasahnya menjadi permata yang cemerlang.
            </p>
            <div className="pt-8">
              <button 
