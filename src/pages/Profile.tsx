...
const visionMission = [
  {
    ...
    description:
      "Menjadi lembaga pendidikan dasar yang unggul dalam teknologi, berkarakter mulia, dan berwawasan global.",
  },
  {
    title: "Misi",
    ...
    <div className="container mx-auto px-4 md:px-6 py-24 space-y-12">
      ...
      <section className="text-center space-y-4">
        ...
        <p className="text-slate-500 dark:text-slate-400 max-w-2xl mx-auto">
          Mengenal lebih dekat SDN KEJURON, tempat di mana masa depan dibangun
          dengan dedikasi dan inovasi.
        </p>
      </section>
      ...
      <section className="bento-card">
        ...
        <div className="prose prose-slate dark:prose-invert max-w-none">
          <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
            Didirikan pada tahun 2010, SDN KEJURON lahir dari visi untuk
            menciptakan sekolah dasar yang tidak hanya fokus pada akademik,
            tetapi juga pada penguasaan teknologi sejak dini. Berawal dari
            sebuah gedung kecil dengan 30 siswa, kini kami telah berkembang
            menjadi salah satu sekolah dasar unggulan yang melayani lebih dari
            800 siswa dengan fasilitas kelas dunia.
          </p>
          <p className="text-slate-700 dark:text-slate-300 leading-relaxed mt-4">
            Selama lebih dari satu dekade, kami terus berinovasi dalam kurikulum
            dan metode pengajaran, mengintegrasikan teknologi EdTech ke dalam
            setiap aspek pembelajaran tanpa melupakan pembentukan karakter dan
      ...
      <section className="bento-card bg-emerald-600 text-white border-none flex flex-col md:flex-row items-center justify-between gap-6 p-10">
        <div className="space-y-2 text-center md:text-left">
          <div className="flex items-center justify-center md:justify-start gap-2">
            ...
            <h2 className="text-3xl font-black">Akreditasi B</h2>
          </div>
          <p className="opacity-80">
            SDN KEJURON telah terakreditasi "Unggul" oleh BAN-S/M dengan nilai
            Baik.
          </p>
        </div>
