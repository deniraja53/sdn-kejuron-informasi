    ...
    <div className="bento-card h-full flex flex-col gap-6 items-center text-center">
      ...
      <div className="flex-1 w-full">
        <div className="flex items-center justify-between mb-4">
          ...
          <Link to="/profil" className="text-[10px] font-black text-primary uppercase tracking-widest hover:underline flex items-center gap-1">
        ...
        <div className="relative px-2">
          ...
          <div className="mt-6 pt-4 border-t-2 border-primary/20">
            <div className="font-bold text-white text-sm">Drs. Ahmad Subarjo, M.Pd</div>
            <div className="text-[10px] text-accent font-black uppercase tracking-widest">Kepala Sekolah</div>
          </div>
        </div>
      </div>
    </div>
