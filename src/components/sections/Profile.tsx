  ...
  return (
    <div className="bento-card h-full">
      ...
      <div className="grid md:grid-cols-2 gap-6 flex-1 items-center">
        <div>
          <h3 className="text-xl font-black text-white mb-2 uppercase tracking-tighter">Visi & Misi Kami</h3>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="bg-primary/5 p-3 rounded-xl border-2 border-primary/30 shadow-[0_0_15px_rgba(255,0,127,0.1)]">
            <div className="text-primary font-black text-2xl drop-shadow-[0_0_8px_rgba(255,0,127,0.5)]">A</div>
            <div className="text-[10px] text-slate-400 uppercase font-black tracking-widest">Akreditasi</div>
          </div>
          <div className="bg-accent/5 p-3 rounded-xl border-2 border-accent/30 shadow-[0_0_15px_rgba(0,243,255,0.1)]">
            <div className="text-accent font-black text-2xl drop-shadow-[0_0_8px_rgba(0,243,255,0.5)]">20+</div>
            <div className="text-[10px] text-slate-400 uppercase font-black tracking-widest">Ekskul</div>
          </div>
        </div>
      </div>
    </div>
