<div align="center">
  <img width="1200" alt="SDN KEJURON Banner" src="https://drive.google.com/uc?export=view&id=1Rr6d67-fp1ZmYteBPKIYJ30-oe7ZQilw" />
</div>
...
1. Install dependencies:
   `npm install`
2. Set the `API KEY` in (.env.local) to your API key
3. Run the app:
   `npm run dev`
